...
const teamMembers: TeamMember[] = [
  {
    ...
    location: 'Yerevan',
    bio: 'Ara is a skilled developer capable of creating client-side websites. He is always eager to learn new technologies and languages. His technical stack includes C, C++, Docker, Docker-Compose, and JavaScript. He holds a Master’s Degree from the National Polytechnical University of Armenia and has completed the Common Core program at 42 international coding school.',
    contributions:
